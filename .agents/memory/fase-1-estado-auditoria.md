...
- **A public lockfile does not guarantee `npm ci` can run inside Replit.** Confirmed on 2026-09-15: Replit's Socket Security Policy returns E403 for the pinned Next.js 14.2.35 tarball because of its critical CVE, even though the lockfile URLs are public. Validate clean installation outside Replit or after the separately scoped framework upgrade.
